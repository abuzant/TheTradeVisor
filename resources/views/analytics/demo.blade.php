<x-public-layout>
    <x-slot name="title">Advanced Global MT4/MT5 Analytics - Demo</x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="mb-8 px-4 sm:px-0">
                <h1 class="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                    Advanced Global Analytics (Demo)
                </h1>
                <p class="mt-1 text-sm text-gray-600">Comprehensive insights from traders worldwide (Last 30 Days)</p>
            </div>
